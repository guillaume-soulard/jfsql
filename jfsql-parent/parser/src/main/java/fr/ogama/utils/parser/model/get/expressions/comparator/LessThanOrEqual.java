...
public class LessThanOrEqual extends ExpressionImpl {

	public LessThanOrEqual(String operator, Expression o1, Expression o2) {
		super(operator, o1, o2);
	}

	public LessThanOrEqual(String op, Expression o1) {
		super(op, o1);
	}

	public LessThanOrEqual(String operator) {
		super(operator);
	}
