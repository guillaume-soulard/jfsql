...
public class Equal extends ExpressionImpl {

	public Equal(String operator, Expression o1, Expression o2) {
		super(operator, o1, o2);
	}

	public Equal(String op, Expression o1) {
		super(op, o1);
	}

	public Equal(String operator) {
		super(operator);
	}
