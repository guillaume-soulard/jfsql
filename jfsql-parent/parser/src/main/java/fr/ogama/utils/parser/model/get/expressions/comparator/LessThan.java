...
public class LessThan extends ExpressionImpl {

	public LessThan(String operator, Expression o1, Expression o2) {
		super(operator, o1, o2);
	}

	public LessThan(String op, Expression o1) {
		super(op, o1);
	}

	public LessThan(String operator) {
		super(operator);
	}
