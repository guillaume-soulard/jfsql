...
public class GreatherThanOrEqual extends ExpressionImpl {

	public GreatherThanOrEqual(String operator, Expression o1, Expression o2) {
		super(operator, o1, o2);
	}

	public GreatherThanOrEqual(String op, Expression o1) {
		super(op, o1);
	}

	public GreatherThanOrEqual(String operator) {
		super(operator);
	}
