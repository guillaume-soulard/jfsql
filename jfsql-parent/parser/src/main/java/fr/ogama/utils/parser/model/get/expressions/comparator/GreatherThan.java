...
public class GreatherThan extends ExpressionImpl {

	public GreatherThan(String operator, Expression o1, Expression o2) {
		super(operator, o1, o2);
	}

	public GreatherThan(String op, Expression o1) {
		super(op, o1);
	}

	public GreatherThan(String operator) {
		super(operator);
	}
