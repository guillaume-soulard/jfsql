...
public class SortTest {
	...
	public static void setup() {
		nameDirectory = System.getProperty("user.dir")
				+ "/src/test/resources/sortDirectory/name";
	...
	public void should_get_in_ascending_and_descending_order() throws Exception {
		// GIVEN
		String ascendingQuery = "get file in('" + nameDirectory
				+ "') sort by name ascending;";
		Statement ascendingFileQuery = JFSQL.parseOneStatement(ascendingQuery);

		String descendingQuery = "get file in('" + nameDirectory
				+ "') sort by name descending;";
		Statement descendingFileQuery = JFSQL
				.parseOneStatement(descendingQuery);

		// WHEN
		List<Comparable> ascendingResults = ascendingFileQuery
				.execute(new HashMap<String, Comparable>());
		List<Comparable> descendingResults = descendingFileQuery
				.execute(new HashMap<String, Comparable>());
	...
	public void should_get_with_limit() throws Exception {
		// GIVEN
		String ascendingQuery = "get 2 file in('" + nameDirectory
				+ "') sort by name ascending;";
		Statement ascendingFileQuery = JFSQL.parseOneStatement(ascendingQuery);

		String descendingQuery = "get 2 file in('" + nameDirectory
				+ "') sort by name descending;";
		Statement descendingFileQuery = JFSQL
				.parseOneStatement(descendingQuery);
