...
public class DeepTest {
	...
	public void should_get_in_level_one_and_two_only() throws Exception {
		// GIVEN
		String query = "get file in ('" + inDirectory1 + "', '" + inDirectory2 + "', '" + inDirectory3 + "') deep 2";
	...
	public void should_get_in_any_level() throws Exception {
		// GIVEN
		String query = "get file in ('" + inDirectory1 + "', '" + inDirectory2 + "', '" + inDirectory3 + "') deep infinite";
		Query fileQuery = QueryFactory.newQuery(query);
	...
	public void should_get_error_because_syntax_error() throws Exception {
		// GIVEN
		String query = "get file in ('" + inDirectory1 + "', '" + inDirectory2 + "', '" + inDirectory3 + "') deep -1";
		Query fileQuery = QueryFactory.newQuery(query);
